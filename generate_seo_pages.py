...
Slow / Dramatic (100 WPM - Keynotes / Storytelling): ${fmt(slowSec)}`;
    ...
    },
    {
        ...
        "h1": "Free AI Text Formatting & Cliché Cleaner (Humanize ChatGPT Copy)",
        "badge": "AI Copy Sanitization Tool",
        "title": "AI Text Formatting & Cliché Cleaner | Humanize ChatGPT & Claude Copy",
        "meta_desc": "Strip Markdown asterisks, excessive em-dashes, and robotic AI clichés from ChatGPT and Claude copy. Prepare clean, professional text for publishing.",
        "keywords": "clean chatgpt text, remove markdown asterisks, humanize AI text layout, strip ai cliches, ai markdown sanitizer free",
        ...
        "instructions": [
            ...
            "The cleaner strips markdown syntax, normalizes em-dashes, and humanizes cliché opening phrases.",
        ...
        "tips": [
            ...
            "Removing cliché opening phrases immediately boosts reader retention in the critical first 5 seconds."
        ],
        "deep_content": """
        ...
        "js_transform": """function transform(input) {
            ...
            cliches.forEach(c => cleaned = cleaned.replace(c, ''));
            return cleaned.trim();
        }"""
    },
    {
